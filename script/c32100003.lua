...
function c32100003.filter(c,e,sp)
	return c:GetAttack()==-2 and c:GetDefense()==-2 and c:IsCanBeSpecialSummoned(e,0,sp,false,false)
end
function c32100003.target1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c32100003.filter,tp,LOCATION_DECK,0,1,nil,e,tp) end
